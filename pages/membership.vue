...
export default {
    ...
    head() {
        return {
            title:
                this.$t('header.membership') + ' ' + this.$t('header.orgName'),
            meta: [
                {
                    hid: 'description',
                    name: 'description',
                    content: this.$t('membership.banner.description'),
                },
                {
                    hid: 'keywords',
                    name: 'keywords',
                    content:
                        '海外留学生生活, 活动, 折扣, 福利优惠, 留学生动态, 课程讲座, 海外校园信息, 最新资讯, GRE考研辅导, ISIC联名学生证, 法律援助, 心理辅导, 学生卡',
                },
            ],
        };
    },
